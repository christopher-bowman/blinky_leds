...
implementation/blinky.bit: xdc source/verilog/top.v source/constraints/Arty-Z7-20-Master.xdc non_project.tcl
ifeq ($(OS), FreeBSD)
	@echo ""
...
xdc: source/constraints/Arty-Z7-20-Master.xdc
	(cd source/constraints;	mv Arty-Z7-20-Master.xdc Arty-Z7-20-Master.xdc.original	; sed -e 's/#\(.*\) clk \(.*\)/\1 clk \2/' Arty-Z7-20-Master.xdc.original | sed -e 's/#\(.*\)led\[\(.*\)/\1led\[\2/' > Arty-Z7-20-Master.xdc )
